...
package com.torkelsen.sondremod.proxy;
...
import com.torkelsen.sondremod.VersionChecker;
import com.torkelsen.sondremod.entities.EntityPigTest;
...
//        ModelLoaderRegistry.registerLoader(new MyModelLoader());
    ...
    public void registerBlockRenderers()
    {
        ...
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_15), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_15.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_14), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_14.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_13), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_13.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_12), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_12.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_11), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_11.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_9), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_9.getUnlocalizedName().substring(5), "inventory"));
        renderItem.getItemModelMesher().register(Item.getItemFromBlock(BlockRegistry.SONDRE_MOD_7), 0, new ModelResourceLocation(MainMod.MODID + ":" + BlockRegistry.SONDRE_MOD_7.getUnlocalizedName().substring(5), "inventory"));
    }
