 ...
 *
 */
public class TileEntitySondreMod extends TileEntity implements ITickable
{
    public EntityPlayer thePlayer;
    
    public TileEntitySondreMod()
    {
...
//        	System.out.println("Setting block to air because player is null");
            if (world.getBlockState(getPos()).getBlock() instanceof BlockSondreMod)
            {
...
//            	System.out.println("Comfirmed that there is moving light source there");
    	...
    	if (! BlockSondreMod.isHoldingLightItem(thePlayer))
        {
        	// DEBUG
